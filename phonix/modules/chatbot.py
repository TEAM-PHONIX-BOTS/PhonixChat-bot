...
from phonix import VENOM
from phonix.modules.helpers import CHATBOT_ON, is_admins


@VENOM.on_message(filters.command(["chatbot"]) & filters.group & ~filters.bot)
@is_admins
async def chaton_off(_, m: Message):
    await m.reply_text(
        f"ᴄʜᴀᴛ: {m.chat.id}\n**ᴘʟᴢ ʙᴀʙᴇ ᴄʜᴏᴏsᴇ 𝟷 ᴏᴘᴛɪᴏɴ ᴇɴᴀʙʟᴇ/ᴅɪsᴀʙʟᴇ ᴄʜᴀᴛ-ʙᴏᴛ.**",
