...
from phonix import BOT_USERNAME, OWNER

DEV_OP = [
    [
        InlineKeyboardButton(text="ᴏᴡɴᴇʀ", user_id=OWNER),
        InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ", url=f"https://t.me/{SUPPORT_GRP}"),
    ],
    [
        InlineKeyboardButton(
            text="ᴀᴅᴅ-ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ʙᴇʙᴇ",
...
MUSIC_BACK_BTN = [
    [
        InlineKeyboardButton(text="søøɴ..", callback_data=f"soom"),
    ],
]
...
ABOUT_BTN = [
    ...
    [
        InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/{UPDATE_CHNL}"),
        InlineKeyboardButton(text="←", callback_data="BACK"),
    ],
]
